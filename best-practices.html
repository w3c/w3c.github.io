            ...
            <section id="all">
                ...
                <section id="2fa">
                    ...
                    <p><a href="https://help.github.com/articles/about-two-factor-authentication/">Two-factor authentication, or 2FA</a>, is an extra layer of
                        ...
                        for which this feature is available&nbsp;&mdash;&nbsp;starting with GitHub.</p>
      ...
      - "%{branch} by %{author} (%{build_url}): %{message}"</pre>
            ...
            <section id="also">
                ...
                <ul>
                    <li>GitHub:
                        <ul>
                            <li>datree: <a href="https://www.datree.io/resources/github-best-practices">&ldquo;Top 10 GitHub Best Practices&rdquo;</a></li>
                            <li>Web Platform Tests:
                                <a href="https://web-platform-tests.org/writing-tests/github-intro.html">&ldquo;Introduction to GitHub&rdquo;</a></li>
                            <li>i18n activity:
